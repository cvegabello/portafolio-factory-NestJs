...
export default function Athletics() {
  return (
    ...
    <div className="relative w-full">
      ...
      <section
        id="athletics"
        className="relative min-h-screen pt-20! pb-20! overflow-hidden flex flex-col items-center justify-center"
      >
        <div className="w-full max-w-[90%] xl:max-w-[1500px] mx-auto px-4 relative z-10">
          {/* TÍTULO: Entra desde abajo */}
          <ScrollAnimation direction="up">
            <SectionTitle
              title={athleticsData.sectionTitle}
              subtitle={athleticsData.sectionSubtitle}
            />
          </ScrollAnimation>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mt-12 items-stretch">
            {/* ======================================================= */}
            {/* COLUMNA IZQUIERDA: VIDEO CARD -> Entra desde la izquierda (direction="right") */}
            {/* ======================================================= */}
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1 md:gap-2 pr-2 overflow-hidden">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-base md:text-xl animate-bounce duration-1000">
                          ⚽
                        </span>
                      </div>
                    ...
                    >
                      ...
                      <ArrowDown
                        size={14}
                        className="md:w-[18px] md:h-[18px] group-hover/btn:translate-y-1 transition-transform"
                      />
                    </a>
                  </div>
                </div>
            ...
            {/* ======================================================= */}
            {/* COLUMNA DERECHA: PERFIL NCSA -> Entra desde la derecha (direction="left") */}
            {/* ======================================================= */}
              ...
              <div className="relative h-full min-h-[550px] w-full group perspective-1000">
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-6 mb-10 border-b border-white/10 pb-6">
                    ...
                    >
                      <img
                        src={athleticsData.ncsa.logoUrl}
                        alt="NCSA"
                    ...
                    {athleticsData.ncsa.stats.map((stat) => (
                      ...
                      >
                        ...
                        <div className="relative z-10 flex flex-col items-center gap-2">
                          <div className="text-gray-500 group-hover/stat:text-accent transition-colors mt-1!">
                            {getIcon(stat.icon)}
                          </div>
      ...
      >
        <div className="w-full max-w-[90%] xl:max-w-[1500px] mx-auto text-center">
          ...
          <div className="mt-12! flex justify-center">
            <a
              href="#athletics"
              className="text-gray-500 hover:text-white transition-colors text-sm uppercase tracking-widest flex flex-col items-center gap-2 animate-pulse cursor-pointer"
            >
              Back to Top
