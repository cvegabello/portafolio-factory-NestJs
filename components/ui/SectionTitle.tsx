...
interface SectionTitleProps {
  title: string;
  subtitle?: string; // 👉 Agregamos el nuevo parámetro
...
export default function SectionTitle({
  ...
  return (
    ...
    <div
      className={`flex flex-col items-center mb-10! mt-6! ml-0 lg:ml-40 ${className}`}
    >
      {/* El Título */}
      ...
      {/* 👇 Lógica nueva: Si hay subtítulo, muéstrelo bonito */}
      {subtitle && (
        <p className="text-gray-400 text-lg mt-3 text-center max-w-2xl px-4">
          {subtitle}
        </p>
      )}
