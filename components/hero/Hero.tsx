  ...
  return (
    ...
    <section id="hero" className="relative w-full h-screen flex items-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center xl:justify-start pl-6 md:pl-16 xl:pl-48! pr-6">
        ...
        {/* === 3. LA TARJETA (CARD) === */}
        <div className="w-[90%] mx-auto! md:w-full xl:w-full xl:mx-0! max-w-xl min-h-[420px] relative rounded-3xl border border-accent shadow-[0_0_30px_rgba(249,115,22,0.6)] overflow-hidden flex flex-col justify-center items-center text-justify">
           ...
           <div className="absolute inset-0 -z-20">
             <Image
               ...
               alt="Card Background"
               fill
               className="object-coverScale-110" // Un pequeño zoom para efecto depth
             />
           </div>
           ...
           <div className="relative z-10 px-8 py-6! md:p-10 lg:p-12 flex flex-col items-center xl:items-start">
            ...
            <h1 className="text-xl md:text-2xl lg:text-[2rem] font-extrabold mb-[10px]! leading-none mt-[25px]! uppercase text-white">
                {heroData.name} <span className="text-accent">{heroData.surname}</span>
            </h1>
            ...
            <div className="w-full flex flex-col sm:flex-row gap-6 items-center justify-center">
              ...
              <Link 
                ...
                className="px-6! py-3! bg-black border-2 border-white/70 text-white font-bold text-base rounded-lg hover:bg-white/10 hover:border-white transition-all duration-300 hover:scale-105 active:scale-95 flex items-center justify-center gap-2 text-center hover:shadow-[0_0_30px_rgba(255,255,255,0.6)]"
              >
